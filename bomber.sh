...
banner() {
    ...
    if [[ "$OSTYPE" == "linux-gnu" ]]; then
	    figlet 'Ankit' | boxes -d cat -a hc -p h8 | lolcat
    else
	    cowsay 'Ankit' | lolcat
    fi
    echo -e "\e[4;34m This bomber was created by Ankit \e[0m" | lolcat
	echo -e "\e[4;34m Mutual consent of the victim is required. \e[0m" | lolcat
	echo -e "\e[1;34m For Any queries contact me!!!\e[0m"| lolcat
	echo -e "\e[1;32m   Intagram:- ankitraj.707\e[0m"| lolcat
    echo ' '| lolcat
...
if [ -f .update ];then
    ...
    echo .
    install_deps
    echo 'This Script Was Made By Ankit Kumar' > .update
...
do
	...
	echo -e "\e[1;32m   Intagram:- ankitraj.707\e[0m"| lolcat
	echo -e " "
	echo -e "\e[1;31m This bomber is only for educational purposes \e[0m"| lolcat
	echo -e "\e[1;31m Do not use this to harm others. \e[0m"| lolcat
	echo -e "\e[1;31m You are responsible for the misuse of the script. \e[0m"| lolcat
	echo  " "
